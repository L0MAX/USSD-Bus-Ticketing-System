    ...
    res.send(response)
            ...
            res.send(response)
              ...
              //level 3 for Kumasi VIP bus
                    let response = `CON You have chosen VIP Bus Transit GHC 70. Enter Mobile Money Wallet Number`
                    res.send(response)
              }else if (text == '2*1*2') {
                    let response = `CON You have chosen VIP Bus Direct GHC 58. Enter Mobile Money Wallet Number`
                    res.send(response)
              }else if (text == '2*1*1') {
              //level 3 for Kumasi Sprinter
                    let response = `CON You have chosen Sprinter Transit GHC 60. Enter Mobile Money Wallet Number`
                    res.send(response)
              }else if (text == '2*1*2') {
                    let response = `CON You have chosen Sprinter Direct GHC 50. Enter Mobile Money Wallet Number`
                    res.send(response)
              }else if (text == '2*1*1') {
              //level 3 for Kumasi Toyota Hiace
                    let response = `CON You have chosen Toyota Hiace Transit GHC 63. Enter Mobile Money Wallet Number`
                    res.send(response)
              }else if (text == '2*1*2') {
                    let response = `CON You have chosen Toyota Hiace Direct GHC 51. Enter Mobile Money Wallet Number`
                    res.send(response)

                  }else if (text == '3*1*1') {
                    //level 3 for Tamale VIP bus
                          let response = `CON You have chosen VIP Bus Direct GHC 120. Enter Mobile Money Wallet Number`
                          res.send(response)
                    }else if (text == '3*2*1') {
                    //level 3 for Tamale Sprinter
                          let response = `CON You have chosen Sprinter Direct GHC 130. Enter Mobile Money Wallet Number`
                          res.send(response)
                    }else if (text == '3*3*1') {
                    //level 3 for Tamale Toyota Hiace
                          let response = `CON You have chosen Toyota Hiace Direct GHC 140. Enter Mobile Money Wallet Number`
                          res.send(response)
                    } else if (text == '1*2') {
